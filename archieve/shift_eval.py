...
# %%
import torch
vit_poly_checkpoint = "tiny_60.pth"


saved_state_dict = torch.load(vit_poly_checkpoint, map_location='cpu')
# %%

model.load_state_dict(saved_state_dict['model'], strict=False)
