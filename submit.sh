...
#SBATCH --job-name=swin_0215
#SBATCH --output=swin_0215.out
#SBATCH --error=swin_0215.err
#SBATCH --mem=64G
...
torchrun  --nproc_per_node 4  main.py --cfg configs/swin/poly_swin_tiny_0215.yaml --data-path /fs/cml-datasets/ImageNet/ILSVRC2012 --output /fs/nexus-projects/shift-equivariant_vision_transformer --fused_window_process 
